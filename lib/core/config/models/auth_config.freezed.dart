...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is AuthConfig&&(identical(other.allowedEmailDomain, allowedEmailDomain) || other.allowedEmailDomain == allowedEmailDomain));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,allowedEmailDomain);

@override
String toString() {
  return 'AuthConfig(allowedEmailDomain: $allowedEmailDomain)';
}
...
/// Create a copy of AuthConfig
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? allowedEmailDomain = null,}) {
  return _then(_self.copyWith(
allowedEmailDomain: null == allowedEmailDomain ? _self.allowedEmailDomain : allowedEmailDomain // ignore: cast_nullable_to_non_nullable
as String,
  ));
}
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String allowedEmailDomain)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _AuthConfig() when $default != null:
return $default(_that.allowedEmailDomain);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String allowedEmailDomain)  $default,) {final _that = this;
switch (_that) {
case _AuthConfig():
return $default(_that.allowedEmailDomain);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String allowedEmailDomain)?  $default,) {final _that = this;
switch (_that) {
case _AuthConfig() when $default != null:
return $default(_that.allowedEmailDomain);case _:
  return null;
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _AuthConfig&&(identical(other.allowedEmailDomain, allowedEmailDomain) || other.allowedEmailDomain == allowedEmailDomain));
}
...
/// Create a copy of AuthConfig
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? allowedEmailDomain = null,}) {
