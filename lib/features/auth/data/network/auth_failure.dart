...
class ServiceUnavailable extends AuthFailure {
  ...
  @override
  String toString() => 'ServiceUnavailable: $serviceName${message != null ? ' - $message' : ''}';
}
...
class InvalidCredentials extends AuthFailure {
  ...
  @override
  String toString() => 'InvalidCredentials${message != null ? ': $message' : ''}';
}

/// SAML request failed
class SamlRequestFailed extends AuthFailure {
  const SamlRequestFailed({
    required this.step,
    this.message,
  });
  ...
  @override
  String toString() => 'SamlRequestFailed at $step${message != null ? ': $message' : ''}';
}

/// Cookie extraction failed
class CookieExtractionFailed extends AuthFailure {
  const CookieExtractionFailed({
  ...
  @override
  String toString() => 'CookieExtractionFailed for $cookieName${message != null ? ': $message' : ''}';
}
...
class SessionRefreshFailed extends AuthFailure {
  ...
  @override
  String toString() => 'SessionRefreshFailed${message != null ? ': $message' : ''}';
}
