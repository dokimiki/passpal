...
abstract class EnvConfig {
  @EnviedField(varName: 'BASE_URL_MANABO', defaultValue: 'https://manabo.cnc.chukyo-u.ac.jp')
  static const String manaboBaseUrl = _EnvConfig.manaboBaseUrl;
  
  @EnviedField(varName: 'BASE_URL_ALBO', defaultValue: 'https://cubics-pt-out.mng.chukyo-u.ac.jp')
...
BASE_URL_ALBO=https://cubics-pt-out.mng.chukyo-u.ac.jp
BASE_URL_MANABO=https://manabo.cnc.chukyo-u.ac.jp
BASE_URL_CUBICS=https://cubics-as-out.mng.chukyo-u.ac.jp
