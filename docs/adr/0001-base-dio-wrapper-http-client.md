...
* Date: 2025-06-22
* Updated: 2025-06-22 (TLS証明書ピニング機能の廃止)
* Template used: [MADR 3.0.0](https://adr.github.io/madr/)

> **Note**: このADRは [ADR-0004](./0004-remove-tls-certificate-pinning.md) により部分的に置き換えられました。TLS証明書ピニング関連の内容は廃止され、DioのデフォルトSSL検証を使用することになりました。
...
* ~~セキュリティ強化のためのTLS証明書ピニング（Firebase Remote Config連携）~~ *(廃止済み)*
