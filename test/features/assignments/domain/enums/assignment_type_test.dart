...
void main() {
  group('AssignmentType', () {
    ...
    test('should parse from plugin key correctly', () {
      ...
      expect(AssignmentType.fromPluginKey('QUIZ'), equals(AssignmentType.quiz));
      expect(AssignmentType.fromPluginKey('report'), equals(AssignmentType.report));
      expect(AssignmentType.fromPluginKey('presentation'), equals(AssignmentType.presentation));
      expect(AssignmentType.fromPluginKey('unknown'), equals(AssignmentType.other));
